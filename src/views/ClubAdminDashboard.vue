<script setup>
import dashboardclub from '@/components/DashboardClub.vue';
    ...
    <main>
        <div class="sidebar-container">
            ...
            <div class="sidebar-menu">
                ...
                <div class="menu-item" @mouseenter="hovered = 0" @mouseleave="hovered = null"
                    :style="{ color: hovered === 0 ? '#214444' : '#ffffff' }" @click="nav('dashboardClub')">
                ...
                <div class="menu-item" @mouseenter="hovered = 1" @mouseleave="hovered = null"
                    :style="{ color: hovered === 1 ? '#214444' : '#ffffff' }" @click="nav('memberList')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"
                        fill="currentColor">
                        <path
                ...
                <div class="menu-item" @mouseenter="hovered = 2" @mouseleave="hovered = null"
                    :style="{ color: hovered === 2 ? '#214444' : '#ffffff' }" @click="nav('reports')">
                ...
                <div class="menu-item" @mouseenter="hovered = 3" @mouseleave="hovered = null"
                    :style="{ color: hovered === 3 ? '#214444' : '#ffffff' }" @click="nav('clubSettings')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"
                        fill="currentColor">
                        <path
                ...
                <div class="menu-item" @mouseenter="hovered = 4" @mouseleave="hovered = null"
                    :style="{ color: hovered === 4 ? '#214444' : '#ffffff' }">
        ...
        <div class="main">
            ...
            <div class="header">
                ...
                <div style="display: flex; gap: 50px;">
                    <h1>Welcome back, Captain!</h1> <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60"
            ...
            <dashboardclub v-if="component1" />
            <memberlist v-if="component2" />
